...
export default function Favorites() {
  ...
  const tabs = [
    ...
    { id: 'food', label: t.favorites.food },
    { id: 'hotel', label: t.favorites.hotel },
    { id: 'movie', label: t.favorites.movie },
    { id: 'beauty', label: t.favorites.beauty },
  ]
    ...
    <div className="min-h-screen bg-gray-50 pb-20">
      <div className="bg-white sticky top-0 z-10">
        <div className="flex items-center justify-between px-4 py-3">
          ...
          <h1 className="text-lg font-bold text-gray-800">{t.favorites.title}</h1>
          <button 
            onClick={() => setIsEditMode(!isEditMode)}
            className="px-4 py-1 text-orange-500 font-medium"
          >
            {isEditMode ? t.favorites.doneEdit : t.favorites.editMode}
          </button>
        </div>
      ...
      <div className="p-4">
        {filteredMerchants.length === 0 ? (
          <div className="text-center py-16">
            ...
            <p className="text-gray-400 text-sm mt-1">{t.favorites.emptyHint}</p>
            <Link 
              to="/category/food" 
              ...
              <div key={merchant.id} className="bg-white rounded-xl p-3 flex gap-3 shadow-sm">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center gap-2 mt-1">
                    ...
                    <span className="text-gray-400 text-sm">{merchant.reviews} {t.merchant.reviews}</span>
                  </div>
